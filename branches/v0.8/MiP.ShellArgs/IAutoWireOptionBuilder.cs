...
namespace MiP.ShellArgs
{
    ...
    public interface IAutoWireOptionBuilder<TContainer>
    {
        /// <summary>
        ...
        IAutoWireOptionCustomizer<TContainer, TArgument> WithOption<TArgument>(string optionName);
        ...
        IAutoWireOptionCustomizer<TContainer, TArgument> WithOption<TArgument>(Expression<Func<TContainer, TArgument>> optionExpression);
    }
}